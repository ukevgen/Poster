...
import com.agilie.poster.adapter.IconsAdapter
import com.agilie.poster.view.fragments.BaseFragment
import kotlinx.android.synthetic.main.fragment_filter.*

class FilterFragment : BaseFragment(), FilterView, IconsAdapter.OnItemClickListener {
	...
	override fun <VH : RecyclerView.ViewHolder?> getAdapter(): RecyclerView.Adapter<VH>? {
		...
		val adapter = IconsAdapter(this.context, filtersList)
